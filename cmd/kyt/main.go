...
var rootCmd = &cobra.Command{
	Use:   "kyt",
	Short: "kyt - Kubernetes YAML Toolkit",
	Long: `kyt normalizes and compares Kubernetes manifests.
...
Use 'kyt <command> --help' for more information about a command.`,
	SilenceUsage:  true,
	SilenceErrors: true,
}

func init() {
	rootCmd.PersistentFlags().StringVarP(&rootConfigFile, "config", "c", "", "config file (default: .kyt.yaml)")
